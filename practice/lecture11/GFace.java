...
public class GFace extends GCompound {
    ...
    // Constants specifying feature size
    ...
    // Create a new GFace object with specified dimensions
    public GFace(double width, double height) {
        ...
        add(head, 0, 0);
        add(leftEye, (0.25 * width) - (EYE_WIDTH * width) / 2, (0.25 * height) - (EYE_HEIGHT * height));
        add(rightEye, (0.75 * width) - (EYE_WIDTH * width) / 2, (0.25 * height) - (EYE_HEIGHT * height));
        add(nose, 0.50 * width, 0.50 * height);
        add(mouth, (0.50 * width) - (MOUTH_WIDTH * width) / 2, (0.75 * height) - (MOUTH_HEIGHT * height));
